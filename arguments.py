...
def args_parser():
    ...
    parser.add_argument('--task', type=str, default='phenotyping', help='in-hospital-mortality,length-of-stay,decompensation,phenotyping,readmission')
    ...
    parser.add_argument('--model', type=str, default='our', help='our model')
