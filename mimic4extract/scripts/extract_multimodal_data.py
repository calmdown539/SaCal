...
from mimic4extract.scripts.utils import split_train_val_test_id,process_note,process_demographics
...
def main():
    ...
    parser.add_argument('demo_path', type=str, help="Directory where the demographics data should be stored.")
    ...
    print('extract required data from raw MIMIC4')
    process_demographics(args.mimic4_path, args.demo_path)
