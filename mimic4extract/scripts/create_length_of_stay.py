...
from mimic4extract.scripts.utils import merge_multimodal_data_without_cxr, create_train_val_test_set, get_bin_custom, random_sample
...
def main():
    ...
    merge_multimodal_data_without_cxr(args, 'length-of-stay')
